...
data merge entity @s {Tags:["customized"],Attributes:[{Name:generic.max_health,Base:300},{Name:generic.movement_speed,Base:0.75}]}
execute as @s[nbt={Health:200f}] run data merge entity @s {Health:300f}
